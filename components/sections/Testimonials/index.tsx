...
const testimonials = [
  {
    ...
    name: 'Ana Ferreira',
    role: 'CEO & Fundadora',
    company: 'TechFlow Lisboa',
    text: 'O Leo transformou completamente a nossa plataforma. Em 3 meses, a taxa de conversão subiu 47% e os utilizadores adoram a nova experiência. É raro encontrar alguém que combina visão estratégica com execução técnica de alto nível.',
    avatar: 'AF',
    color: '#2079f5',
    stars: 5,
    category: 'Cliente'
  },
  {
    ...
    name: 'Ricardo Santos',
    role: 'CTO',
    company: 'Nexo Finance',
    text: 'Trabalhar com o Leo foi uma das melhores decisões que tomámos. O sistema de design que construiu reduziu o tempo de desenvolvimento em 60% e a consistência visual da app é impecável. Recomendo sem reservas.',
    avatar: 'RS',
    color: '#10b981',
    stars: 5,
    category: 'Parceiro'
  },
  {
    ...
    company: 'Lume Health',
    text: 'O Leo tem uma capacidade única de entender os problemas dos utilizadores e traduzi-los em soluções elegantes. O nosso NPS passou de 42 para 78 depois do redesign que ele liderou. Excepcional!',
    avatar: 'SM',
    color: '#6366f1',
    stars: 5,
    category: 'Cliente'
  },
  {
    ...
    role: 'Lead Developer',
    company: 'Atlas Ops',
    text: 'Colaborei com o Leo em vários projetos. O código que entrega é limpo, bem documentado e segue as melhores práticas. É o tipo de profissional que eleva toda a equipa. Um verdadeiro parceiro.',
    avatar: 'MC',
    color: '#f59e0b',
    stars: 5,
