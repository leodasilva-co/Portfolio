...
const workProjects: WorkProject[] = [
  // Design
  {
    ...
    images: ['/images/hero-finance-02.png', '/images/hero-finance-02.png', '/images/hero-finance-02.png'],
  ...
  },
  {
    ...
    images: ['/images/hero-finance-02.png', '/images/hero-finance-02.png'],
  ...
  {
    id: 3,
    title: 'Aricia — evento e ATELIER',
    type: 'Identidade Visual',
    description: 'Do catálogo disperso a uma loja que converte.',
    fullDescription: 'Criação de identidade visual completa para a marca de moda Aricia — evento e ATELIER, incluindo logo, paleta de cores, tipografia, e guidelines para aplicação digital e física.',
    category: 'design',
    tags: ['Logo','Paleta de cores','Tipografia', 'Manual de identidade', 'Cartões de visita', 'Papel timbrado', 'Aplicações da marca', 'Mockups'],
    images: ['/images/hero-design-01.png', '/images/hero-design-02.png', '/images/hero-design-03.png', '/images/hero-design-04.png', '/images/hero-design-05.png', '/images/hero-design-06.png', '/images/hero-design-07.png'],
